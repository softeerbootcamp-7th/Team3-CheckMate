    ...
    <div className="flex w-[1060px] flex-col gap-13">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-5">
          <Skeleton className="rounded-400 bg-grey-200 h-70 flex-1" />
          <Skeleton className="rounded-400 bg-grey-200 h-70 flex-1" />
          <Skeleton className="rounded-400 bg-grey-200 h-70 flex-1" />
        </div>
        <div className="flex gap-5">
          <Skeleton className="rounded-400 bg-grey-200 h-38 w-107" />
          <Skeleton className="rounded-400 bg-grey-200 h-38 flex-1" />
        </div>
      </div>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-5">
          <Skeleton className="rounded-400 bg-grey-200 h-113 flex-1" />
          <Skeleton className="rounded-400 bg-grey-200 h-113 flex-1" />
          <Skeleton className="rounded-400 bg-grey-200 h-113 flex-1" />
        </div>
      </div>
