...
export const getRealSalesCardCode = (
  periodType?: PeriodType<typeof PERIOD_PRESET_KEYS.dayWeekMonth>,
) => {
  switch (periodType) {
    case PERIOD_PRESETS.dayWeekMonth.today:
      return SALES_METRIC.CURRENT_SALES.REAL_SALES.cardCodes.today;
    case PERIOD_PRESETS.dayWeekMonth.thisWeek:
      return SALES_METRIC.CURRENT_SALES.REAL_SALES.cardCodes.thisWeek;
    case PERIOD_PRESETS.dayWeekMonth.thisMonth:
      return SALES_METRIC.CURRENT_SALES.REAL_SALES.cardCodes.thisMonth;
    default:
      return SALES_METRIC.CURRENT_SALES.REAL_SALES.cardCodes.today;
  }
};
