...
export const getPayMethodCardCode = (
  periodType?: PeriodType<typeof PERIOD_PRESET_KEYS.dayWeekMonth>,
) => {
  switch (periodType) {
    case PERIOD_PRESETS.dayWeekMonth.today:
      return SALES_METRIC.SALES_SOURCE.PAY_METHOD.cardCodes.today;
    case PERIOD_PRESETS.dayWeekMonth.thisWeek:
      return SALES_METRIC.SALES_SOURCE.PAY_METHOD.cardCodes.thisWeek;
    case PERIOD_PRESETS.dayWeekMonth.thisMonth:
      return SALES_METRIC.SALES_SOURCE.PAY_METHOD.cardCodes.thisMonth;
    default:
      return SALES_METRIC.SALES_SOURCE.PAY_METHOD.cardCodes.today;
  }
};
