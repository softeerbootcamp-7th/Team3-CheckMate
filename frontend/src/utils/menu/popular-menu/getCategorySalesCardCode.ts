...
export const getCategorySalesCardCode = (
  periodType?: PeriodType<typeof PERIOD_PRESET_KEYS.today7_30>,
) => {
  switch (periodType) {
    case PERIOD_PRESETS.today7_30.today:
      return MENU_METRIC.POPULAR_MENU.CATEGORY_SALES.cardCodes.today;
    case PERIOD_PRESETS.today7_30.recent7Days:
      return MENU_METRIC.POPULAR_MENU.CATEGORY_SALES.cardCodes.recent7Days;
    case PERIOD_PRESETS.today7_30.recent30Days:
      return MENU_METRIC.POPULAR_MENU.CATEGORY_SALES.cardCodes.recent30Days;
    default:
      return MENU_METRIC.POPULAR_MENU.CATEGORY_SALES.cardCodes.today;
  }
};
